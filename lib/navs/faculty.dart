...
class _FacultyState extends State<Faculty> {
  ...
  Widget appBar() {
    return AppBar(
      ...
      title: const Text('Faculty Module'),
      actions: <Widget>[
    ...
    return Builder(
      builder: (BuildContext context) {
        return IndexedStack(
          ...
          children: <Widget>[
            WebView(
              initialUrl: 'https://sis8.pup.edu.ph/faculty/index.php',
              ...
              navigationDelegate: (NavigationRequest request) {
                if (request.url.startsWith('https://www.pup.edu.ph/') ||
                    request.url.startsWith('https://apps.pup.edu.ph/')) {
                  print(request.url + ' is Lauched outside app.');
                  ...
                  print(request.url + ' is navigated.');
                  return NavigationDecision.navigate;
                } else {
                  print(request.url + ' is prevented.');
